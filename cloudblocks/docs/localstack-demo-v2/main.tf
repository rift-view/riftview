################################################################################
# Cloudblocks LocalStack Demo — "Static Website with API" fixture
#
# Purpose: exercise every Cloudblocks-visualised service type, trigger advisory
...
resource "aws_vpc" "main" {
  ...
  tags = { Name = "demo-vpc", Project = "cloudblocks-demo" }
}

resource "aws_internet_gateway" "main" {
  vpc_id = aws_vpc.main.id
  tags   = { Name = "demo-igw", Project = "cloudblocks-demo" }
}
...
resource "aws_subnet" "public" {
  ...
  tags = { Name = "demo-public-subnet", Project = "cloudblocks-demo" }
}
...
resource "aws_subnet" "private" {
  ...
  availability_zone = "${local.region}a"
  tags = { Name = "demo-private-subnet", Project = "cloudblocks-demo" }
}
...
resource "aws_security_group" "bastion" {
  ...
  tags = { Name = "demo-bastion-sg", Project = "cloudblocks-demo" }
}
...
resource "aws_security_group" "app" {
  ...
  tags = { Name = "demo-app-sg", Project = "cloudblocks-demo" }
}
...
resource "aws_instance" "bastion" {
  ...
  tags = { Name = "demo-bastion", Project = "cloudblocks-demo" }
}
...
resource "aws_s3_bucket" "static_assets" {
  bucket = "demo-static-assets-cloudblocks"
  ...
  tags = { Name = "demo-static-assets", Project = "cloudblocks-demo" }
}

# Correctly configured bucket (no advisories should fire)
resource "aws_s3_bucket" "artifacts" {
  bucket = "demo-artifacts-cloudblocks"
  tags   = { Name = "demo-artifacts", Project = "cloudblocks-demo" }
}
...
resource "aws_dynamodb_table" "sessions" {
  ...
  tags = { Name = "demo-sessions", Project = "cloudblocks-demo" }
}
...
resource "aws_sqs_queue" "workflow_dlq" {
  ...
  tags                      = { Name = "demo-workflow-dlq", Project = "cloudblocks-demo" }
}
...
resource "aws_sqs_queue" "workflow" {
  ...
  tags = { Name = "demo-workflow-queue", Project = "cloudblocks-demo" }
}
...
# Note: SQS node ID in Cloudblocks is the queue ARN (required for SNS→SQS edge)
################################################################################
...
resource "aws_sns_topic" "events" {
  name = "demo-events"
  tags = { Name = "demo-events", Project = "cloudblocks-demo" }
}

# SNS → SQS subscription (creates integration edge in Cloudblocks)
...
resource "aws_lambda_function" "timeout_test" {
  ...
  tags = { Name = "demo-timeout-test", Project = "cloudblocks-demo" }
...
resource "aws_lambda_function" "workflow_processor" {
  ...
  tags = { Name = "demo-workflow-processor", Project = "cloudblocks-demo" }
...
resource "aws_acm_certificate" "main" {
  domain_name       = "demo.cloudblocks.local"
  validation_method = "DNS"

  subject_alternative_names = [
    "api.cloudblocks.local",
    "*.cloudblocks.local",
  ]

  tags = { Name = "demo-cert", Project = "cloudblocks-demo" }
...
resource "aws_cloudfront_distribution" "main" {
  ...
  tags = { Name = "demo-distribution", Project = "cloudblocks-demo" }
}
...
resource "aws_route53_zone" "main" {
  name    = "cloudblocks.local"
  comment = "Demo hosted zone for Cloudblocks LocalStack fixture"
  tags    = { Project = "cloudblocks-demo" }
}

resource "aws_route53_record" "api" {
  zone_id = aws_route53_zone.main.zone_id
  name    = "api.cloudblocks.local"
  type    = "CNAME"
  ttl     = 300
...
resource "aws_sfn_state_machine" "order_workflow" {
  ...
  tags = { Name = "demo-order-workflow", Project = "cloudblocks-demo" }
}
...
resource "aws_ses_domain_identity" "main" {
  domain = "cloudblocks.local"
}

resource "aws_ses_email_identity" "notifications" {
  email = "notifications@cloudblocks.local"
}
