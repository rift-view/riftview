# Terminus + Firefly.ai — Coexistence Framing

## One-line pitch for Firefly users

> Terminus is what you look at **before** you approve Firefly's plan.
...
Terminus is the **visual diagnostic layer**. Click a broken resource,
...
| Concern | Firefly answers | Terminus answers |
|---|---|---|
...
which direction, with which edge type. Terminus's core value is that
...
cleanly, Terminus is optional. The overlap is small enough that you can
pilot Terminus for diagnostic value without displacing Firefly.
...
the queue that Lambda writes to. Terminus anchors on structure first,
metrics second.

## Messaging by channel

- **Cold email to Firefly users:** "If you're already using Firefly for
  recovery, Terminus is the pre-flight check. 15-minute demo?"
