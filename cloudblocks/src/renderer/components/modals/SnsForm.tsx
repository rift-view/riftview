...
interface Props { onChange: (p: SnsParams) => void; showErrors?: boolean }
  ...
  return (
    <div>
      ...
      <input
        ...
        onChange={(e) => { setName(e.target.value); emit(e.target.value, fifo) }}
      />
      ...
      <label style={checkRow}>
        <input
          type="checkbox"
          checked={fifo}
          onChange={(e) => { setFifo(e.target.checked); emit(name, e.target.checked) }}
        />
