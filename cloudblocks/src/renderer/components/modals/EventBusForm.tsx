...
interface Props { onChange: (p: EventBusParams) => void; showErrors?: boolean }
  ...
  return (
    <div>
      ...
      <input
        ...
        onChange={(e) => { setName(e.target.value); onChange({ resource: 'eventbridge-bus', name: e.target.value }) }}
      />
    </div>
  )
}
