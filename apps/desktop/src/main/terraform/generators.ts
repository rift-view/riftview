...
export const terraformGenerators: TerraformGeneratorMap = {
  'aws:vpc': generateVpc,
  'aws:subnet': generateSubnet,
  'aws:ec2': generateEc2,
  'aws:s3': generateS3,
  'aws:lambda': generateLambda,
  'aws:rds': generateRds,
  'aws:alb': generateAlb,
  'aws:security-group': generateSg,
  'aws:igw': generateIgw,
  'aws:acm': generateAcm,
  'aws:cloudfront': generateCloudFront,
  'aws:apigw': generateApigw,
  'aws:apigw-route': generateApigwRoute,
  'aws:sqs': generateSqs,
  'aws:secret': generateSecret,
  'aws:ecr-repo': generateEcr,
  'aws:sns': generateSns,
  'aws:dynamo': generateDynamo,
  'aws:ssm-param': generateSsmParam,
  'aws:nat-gateway': generateNatGateway,
  'aws:r53-zone': generateR53Zone,
  'aws:sfn': generateSfn,
  'aws:eventbridge-bus': generateEventBridgeBus,
  'aws:ses': generateSes,
  'aws:cognito': generateCognito,
  'aws:kinesis': generateKinesis,
  'aws:ecs': generateEcs,
  'aws:elasticache': generateElastiCache,
  'aws:eks': generateEks,
